...
files = [
  ...
  'libs/angular-1.0.4/angular.js',
  'libs/angular-1.0.4/angular-resource.js',
  'libs/angular-1.0.4/angular-mocks.js',
  'src/**/*.js',
  'test/E2E/*.js'
];
...
proxies = {
  '/': 'http://'+address+':8000/',
  '/libs': 'http://'+address+':8000/libs',
  '/build' : 'http://'+address+':8000/build',
  '/resources':'http://'+address+':8000/resources',
  '/src':'http://'+address+':8000/src'
};
...
// browsers = ['Chrome','Firefox','Safari','/workspace/jcf-ui-framework/ie9.sh','/workspace/jcf-ui-framework/ie8.sh'];
